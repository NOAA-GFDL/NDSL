...
def mpp_reproducing_sum_r8_2d(lib_fms, array, isr, ier, jsr, jer, EFP_sum, reproducing, overflow_check, err):
    lib_fms.mpp_reproducing_sum_r8_2d(array, isr, ier, jsr, jer, EFP_sum, reproducing, overflow_check, err)

def mpp_reproducing_sum_r4_2d(lib_fms, array, isr, ier, jsr, jer, EFP_sum, reproducing, overflow_check, err):
    lib_fms.mpp_reproducing_sum_r4_2d(array, isr, ier, jsr, jer, EFP_sum, reproducing, overflow_check, err)
