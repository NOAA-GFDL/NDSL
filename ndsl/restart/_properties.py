...
RESTART_PROPERTIES: RestartProperties = {
    ...
    "accumulated_x_mass_flux": {
        "dims": [K_DIM, J_DIM, I_INTERFACE_DIM],
        "restart_name": "mfx",
        "units": "unknown",
    },
    ...
    "accumulated_y_mass_flux": {
        "dims": [K_DIM, J_INTERFACE_DIM, I_DIM],
        "restart_name": "mfy",
        "units": "unknown",
    },
    "air_temperature": {
    ...
    "interface_pressure": {
        "dims": [J_DIM, K_INTERFACE_DIM, I_DIM],
        "restart_name": "pe",
        "units": "Pa",
    },
    "interface_pressure_raised_to_power_of_kappa": {
        "dims": [K_INTERFACE_DIM, J_DIM, I_DIM],
        "restart_name": "pk",
        "units": "unknown",
    },
    "land_sea_mask": {
    ...
    "latitude": {"dims": [J_DIM, I_DIM], "restart_name": "xlat", "units": "radians"},
    ...
    "longitude": {"dims": [J_DIM, I_DIM], "restart_name": "xlon", "units": "radians"},
    ...
    "soil_type": {"dims": [J_DIM, I_DIM], "restart_name": "stype", "units": ""},
    ...
    "surface_pressure": {"dims": [J_DIM, I_DIM], "restart_name": "ps", "units": "Pa"},
    "surface_roughness": {
        "dims": [J_DIM, I_DIM],
        "restart_name": "zorl",
        "units": "cm",
    ...
    "vegetation_type": {"dims": [J_DIM, I_DIM], "restart_name": "vtype", "units": ""},
